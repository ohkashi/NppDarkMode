...
namespace NppDarkMode
{
	...
	void initDarkMode(bool bWindowMode = true);				// pulls options from NppParameters
...
class NppTheme final
{
public:
	static NppTheme& getInstance() noexcept {
...
private:
	NppTheme() = default;
	~NppTheme() {}
	static NppTheme* getInstancePointer() noexcept;
